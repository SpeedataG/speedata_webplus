...
import com.speedata.webplus.common.persistence.PropertyFilter.MatchType;
import com.speedata.webplus.common.utils.Reflections;
 ...
 * 
 */
public class BaseDaoImpl<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> {
	/**
	 * 用于Dao层子类的构造函数.
