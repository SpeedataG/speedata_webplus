...
<script src="${ctx}/static/js/apiProject.js" type="text/javascript"></script>
...
<div id="tb" style="padding:5px;height:auto">
        ...
        <div class="search">
        	<form id="searchFrom" action="">
	       	...
	       	<shiro:hasPermission name="sys:apiProject:add">
	       		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="glyphicon-plus" plain="true" onclick="add();">添加</a>
	       		<span class="toolbar-item dialog-tool-separator"></span>
	       	</shiro:hasPermission>
	       	<shiro:hasPermission name="sys:apiProject:delete">
	            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" data-options="disabled:false" onclick="del()">删除</a>
	        	<span class="toolbar-item dialog-tool-separator"></span>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="sys:apiProject:update">
	            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="glyphicon-pencil" plain="true" onclick="upd()">修改</a>
	            <span class="toolbar-item dialog-tool-separator"></span>
	        </shiro:hasPermission>
	      <shiro:hasPermission name="sys:apiProject:genApi">
	            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="glyphicon-pencil" plain="true" onclick="genApi()">生成api文档</a>
	            <span class="toolbar-item dialog-tool-separator"></span>
	        </shiro:hasPermission>
        </div> 
