...
<div class="search">
		<form id="searchFrom" action="">
			<input type="text" name="filter_LIKES_operationCode" class="easyui-validatebox input" data-options="width:150,prompt: '操作编码'"/>
			<input type="text" name="filter_LIKES_description" class="easyui-validatebox input" data-options="width:150,prompt: '操作内容'"/>
	        <input type="text" name="filter_GTD_createDate" class="easyui-my97 input" datefmt="yyyy-MM-dd HH:mm:ss" data-options="width:150,height:28,prompt: '操作开始日期'" />
	        - <input type="text" name="filter_LTD_createDate" class="easyui-my97 input" datefmt="yyyy-MM-dd HH:mm:ss" data-options="width:150,height:28,prompt: '操作结束日期'"/>
