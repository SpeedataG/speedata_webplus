...
insert  into `api_menu`(`id`,`parent_id`,`menu_name`,`href`,`remark`,`create_time`,`update_time`,`sort`) values (1,NULL,'å‡ºåº“å•','',NULL,'2017-02-10 08:48:42','2017-02-22 08:48:45',1),(2,NULL,'å…¥åº“å•','',NULL,NULL,NULL,2),(3,NULL,'ç›˜ç‚¹å•',NULL,NULL,NULL,NULL,3),(4,1,'å‡ºåº“å•æŸ¥è¯¢','outsearch',NULL,NULL,NULL,4),(5,1,'æ–°å¢å‡ºåº“å•','add_outware',NULL,NULL,NULL,5),(6,2,'å…¥åº“å•æŸ¥è¯¢','/inWare/list',NULL,NULL,NULL,6);
...
insert  into `api_project`(`id`,`project_name`,`remark`,`create_time`,`update_time`) values (1,'è®¾å¤‡è¿½æº¯é¡¹ç›®','äºŒäººè‹¥','2017-01-27 17:39:11','2017-01-27 17:43:28');
...
insert  into `qrtz_scheduler_state`(`SCHED_NAME`,`INSTANCE_NAME`,`LAST_CHECKIN_TIME`,`CHECKIN_INTERVAL`) values ('scheduler','pc-PC1486991435061',1486993011092,15000);
